...
import json
# data generation
import models.dlrm.dlrm_data_pytorch as dp
...
from models.dlrm.tricks.qr_embedding_bag import QREmbeddingBag
# mixed-dimension trick
from models.dlrm.tricks.md_embedding_bag import PrEmbeddingBag, md_solver
...
class DLRM_Net(nn.Module):
    ...
    def __init__(
        ...
        if (
            ...
            self.interaction_l = InteractionLayer(arch_interaction_op, arch_interaction_itself)
    ...
    def interact_features(self, x, ly):
        ...
        #
        # return R
        return self.interaction_l(x, ly)
